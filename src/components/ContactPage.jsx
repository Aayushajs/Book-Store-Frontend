        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-1/3 bg-gray-100 dark:bg-gray-800 shadow-lg rounded-lg p-8">
            ...
            <ul className="space-y-4">
              <li>
                <span className="font-medium text-gray-700 dark:text-gray-300">Phone:</span> +1 123 456 7890
              </li>
              <li>
                <span className="font-medium text-gray-700 dark:text-gray-300">Email:</span> contact@bookstore.com
              </li>
              <li>
                <span className="font-medium text-gray-700 dark:text-gray-300">Address:</span> 123 Bookstore St., City, Country
              </li>
            </ul>
